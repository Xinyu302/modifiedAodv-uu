...
/** added by BUAA_Yxy **/
struct packet_queue PQ_RPR;

void packet_queue_rpr_add(Packet * p, struct in_addr dest_addr);
void packet_queue_rpr_init();
void packet_queue_rpr_destroy();
int packet_queue_set_rpr_verdict(struct in_addr dest_addr, int verdict);
int packet_queue_garbage_rpr_collect(void);
/** end added by BUAA_Yxy **/
